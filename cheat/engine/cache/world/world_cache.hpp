...
private:
    ...
    std::uintptr_t m_tracemng = 0;
    std::uintptr_t m_physx_world_ptr = 0;
    std::uintptr_t m_physx_world = 0;
    std::uintptr_t m_spatial_trees_base = 0;

    std::uintptr_t m_prev_spatial_trees_base;
